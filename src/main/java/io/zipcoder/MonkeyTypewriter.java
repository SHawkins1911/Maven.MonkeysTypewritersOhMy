...
public class MonkeyTypewriter {
    public static void main(String[] args) {
        ...
        monkeySeeMonkeyType(unsafe, 5);

        SafeCopier safe = new SafeCopier(introduction);
        monkeySeeMonkeyType(safe, 5);
    ...
    public static void monkeySeeMonkeyType(Copier copier, Integer monkeys){
        Stream<Thread> myStream = Stream.generate(() -> new Thread(copier)).limit(monkeys);
        myStream.forEach(Thread::start);
    }
}